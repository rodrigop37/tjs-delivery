...
<div class="woocommerce-shipping-fields">
	<?php if ( WC()->cart->needs_shipping_address() === true ) : ?>
		...
		<h2 id="ship-to-different-address" class="black-text font-weight-600 text-uppercase text-large">
			<input id="ship-to-different-address-checkbox" class="margin-left-right-one no-margin-left input-checkbox" <?php checked( $ship_to_different_address, 1 ); ?> type="checkbox" name="ship_to_different_address" value="1" />
