            ...
            <div class="wrap about-wrap">
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php wp_kses( 'We do our best to provide the best support we can. If you encounter a problem or have a question, post a question in the <a href="' . 'https://' . 'easydigitaldownloads.com/support">support forums</a>.', 'redux-framework' ); ?></p>

                        <h4><?php _e( 'Need Even Faster Support?', 'redux-framework' ); ?></h4>

                        <p><?php wp_kses( 'Our <a href="' . 'https://' . 'easydigitaldownloads.com/support/pricing/">Priority Support forums</a> are there for customers that need faster and/or more in-depth assistance.', 'redux-framework' ); ?></p>
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php wp_kses( 'New extensions that make Easy Digital Downloads even more powerful are released nearly every single week. Subscribe to the newsletter to stay up to date with our latest releases. <a href="' . 'http://' . 'eepurl.com/kaerz" target="_blank">Signup now</a> to ensure you do not miss a release!', 'redux-framework' ); ?></p>

                        <h4><?php _e( 'Get Alerted About New Tutorials', 'redux-framework' ); ?></h4>

                        <p><?php wp_kses( '<a href="' . 'http://' . 'eepurl.com/kaerz" target="_blank">Signup now</a> to hear about the latest tutorial releases that explain how to take Easy Digital Downloads further.', 'redux-framework' ); ?></p>
                ...
                <div class="changelog">
                    ...
                    <div class="feature-section">
                        ...
                        <p><?php wp_kses( '<a href="' . 'https://' . 'asydigitaldownloads.com/extensions" target="_blank">The Extensions store</a> has a list of all available extensions, including convenient category filters so you can find exactly what you are looking for.', 'redux-framework' ); ?></p>
