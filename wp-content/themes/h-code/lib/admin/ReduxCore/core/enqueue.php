...
if (!class_exists('reduxCoreEnqueue')){
    class reduxCoreEnqueue {
         ...
         */ 
            ...
            wp_enqueue_script(
                'hcode-accordion',
                ReduxFramework::$_url . 'assets/js/hcode-accordion.js',
                array( 'redux-field-import-export-js' ),
                '1.0',
                true
            );
            ...
            */ 
            wp_enqueue_script(
                'hcode-ajax-button-save-script-option',
                ReduxFramework::$_url . 'assets/js/hcode-ajax-save.js',
                array( 'hcode-accordion' ),
                '1.0',
                true
            );
            wp_localize_script(
                'hcode-ajax-button-save-script-option',
                'hcode_ajax_button_save',
