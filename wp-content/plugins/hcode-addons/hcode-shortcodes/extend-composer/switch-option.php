<?php
/**
 * H-Code Custom Switch For VC.
 *
 * @package H-Code
 */
?>
<?php 
vc_add_shortcode_param( 'hcode_custom_switch_option', 'hcode_custom_switch_option_settings_field', HCODE_ADDONS_ROOT_DIR . '/hcode-shortcodes/js/custom.js');
if ( ! function_exists( 'hcode_custom_switch_option_settings_field' ) ) :
  function hcode_custom_switch_option_settings_field( $settings, $value ) {
